package com.github.cao.awa.conium.mixin.datapack.block;
...
@Mixin(ConiumBlockManager.class)
public abstract class ConiumBlockManagerMixin implements FabricResourceReloader {
    @Override
