...
class ConiumBlockScheduleTickEvent : ConiumEvent<ParameterSelective5<Boolean, ServerWorld, BlockPos, AbstractBlockState, ScheduledTickView, Random>>(ConiumEventType.BLOCK_SCHEDULE_TICK) {
