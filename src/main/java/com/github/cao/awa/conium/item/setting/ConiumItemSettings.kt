...
object ConiumItemSettingsValue {
    val canMinePredicate: (Item, BlockState, World, BlockPos, PlayerEntity) -> Boolean = { _, _, _, _, _ -> true }
...
abstract class ConiumAbstractItemSettings<B : ConiumAbstractItemSettings<B>>(val vanillaSettings: Item.Settings) : ConiumSettings<ConiumAbstractItemSettings<B>, B>() {
     ...
     * @since 1.0.0
     */
    var canMinePredicate: (Item, BlockState, World, BlockPos, PlayerEntity) -> Boolean
    ...
    // The delegate.
    private var _canMinePredicate: ((Item, BlockState, World, BlockPos, PlayerEntity) -> Boolean)? = null
