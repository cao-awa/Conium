 ...
 * @since 1.0.0
 */
class ConiumTrappedChestClosedEvent : ConiumEvent<ParameterSelective6<Boolean, World, PlayerEntity, TrappedChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>>() {
    override fun requirement(): ConiumEventContext<out ParameterSelective> {
        return requires(
            ...
            forever(ConiumEventType.TRAPPED_CHEST_CLOSED)
        ).arise { identity: Any,
                  world: World,
                  player: PlayerEntity,
    ...
    override fun attach() {
        ...
        ConiumEventContextBuilder.preRequest(
            ...
            blockPos: BlockPos,
            viewerManager: ViewerCountManager ->
            val trappedContext: ConiumEventContext<*> = request(ConiumEventType.TRAPPED_CHEST_CLOSED)
