package com.github.cao.awa.conium.blockentity.event.chest.trapped.closing.metadata
...
class ConiumTrappedChestClosingEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumTrappedChestClosingEventMetadata>() {
