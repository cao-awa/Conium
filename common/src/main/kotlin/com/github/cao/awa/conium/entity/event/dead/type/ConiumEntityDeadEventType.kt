package com.github.cao.awa.conium.entity.event.dead.type
...
class ConiumEntityDeadEventType: ConiumNoCancelableEventType<EntityType<*>, ConiumEntityDeadEventMetadata, Unit, ConiumInactiveEventMetadata>(
    "entity_dead",
    "EntityType",
    ConiumEvent.Companion::entityDead
)