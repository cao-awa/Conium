...
class ConiumBreakingBlockEvent : ConiumEvent<Block, ConiumBreakingBlockEventMetadata, ParameterSelective4<Boolean, World, PlayerEntity, BlockPos, AbstractBlockState>, ConiumBreakBlockEventType>(
