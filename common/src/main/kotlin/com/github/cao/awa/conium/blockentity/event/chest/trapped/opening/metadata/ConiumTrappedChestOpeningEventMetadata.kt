package com.github.cao.awa.conium.blockentity.event.chest.trapped.opening.metadata
...
class ConiumTrappedChestOpeningEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumTrappedChestOpeningEventMetadata>() {
