...
class ConiumEntitySleepEventType: ConiumNoCancelableEventType<EntityType<*>, ConiumEntitySleepEventMetadata, Unit, ConiumInactiveEventMetadata>(
    "entity_sleep",
    "EntityType",
    ConiumEvent.Companion::entitySleep
)