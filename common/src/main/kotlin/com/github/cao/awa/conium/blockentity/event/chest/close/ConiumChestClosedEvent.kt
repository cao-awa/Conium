package com.github.cao.awa.conium.blockentity.event.chest.close
 ...
 * @since 1.0.0
 */
class ConiumChestClosedEvent : ConiumEvent<Block, ConiumChestClosedEventMetadata, ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>>(
