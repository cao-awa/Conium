 ...
 * @since 1.0.0
 */
class ConiumChestClosedEvent : ConiumEvent<Block, ConiumChestClosedEventMetadata, ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlock.AbstractBlockState, BlockPos, ViewerCountManager>, ConiumInactiveEventType>(
