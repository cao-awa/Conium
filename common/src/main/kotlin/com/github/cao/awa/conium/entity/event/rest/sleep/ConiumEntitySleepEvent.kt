...
class ConiumEntitySleepEvent : ConiumEvent<ParameterSelective3<Boolean, World, LivingEntity, BlockPos>, ConiumEntitySleepEventMetadata>(
    ...
    override fun metadata(context: ConiumEventContext): ConiumEntitySleepEventMetadata {
