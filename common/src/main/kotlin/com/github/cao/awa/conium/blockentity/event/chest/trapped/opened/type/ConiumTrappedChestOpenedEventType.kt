package com.github.cao.awa.conium.blockentity.event.chest.trapped.opened.type
...
class ConiumTrappedChestOpenedEventType: ConiumNoCancelableEventType<Block, ConiumTrappedChestOpenedEventMetadata, Unit, ConiumInactiveEventMetadata >(
    "trapped_chest_opened",
    "Block",
    ConiumEvent.Companion::trappedChestOpened
)