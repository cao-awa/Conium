package com.github.cao.awa.conium.blockentity.event.shulker.close
...
class ConiumShulkerBoxClosingEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block>() {
