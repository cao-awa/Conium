package com.github.cao.awa.conium.molang.translator.element.program.statement.invoke.param
...
interface MolangInvokeParamElementTranslator: StructuringElementTranslator<MolangInvokeParam>  {
}