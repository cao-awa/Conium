package com.github.cao.awa.conium.blockentity.event.shulker.opened.metadata
...
class ConiumShulkerBoxOpenedEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumShulkerBoxOpenedEventMetadata>() {
