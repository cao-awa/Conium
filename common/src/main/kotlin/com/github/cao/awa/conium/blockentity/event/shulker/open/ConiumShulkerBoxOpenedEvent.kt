package com.github.cao.awa.conium.blockentity.event.shulker.open
 ...
 * @since 1.0.0
 */
class ConiumShulkerBoxOpenedEvent : ConiumEvent<Block, ConiumShulkerBoxOpenedEventMetadata, ParameterSelective5<Boolean, World, PlayerEntity, ShulkerBoxBlockEntity, AbstractBlockState, BlockPos>>(
