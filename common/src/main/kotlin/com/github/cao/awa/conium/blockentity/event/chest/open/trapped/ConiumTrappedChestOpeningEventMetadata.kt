package com.github.cao.awa.conium.blockentity.event.chest.open.trapped
...
class ConiumTrappedChestOpeningEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block>() {
