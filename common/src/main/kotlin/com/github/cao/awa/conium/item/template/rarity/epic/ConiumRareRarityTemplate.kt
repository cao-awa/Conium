...
import com.github.cao.awa.conium.template.item.conium.ConiumItemTemplates.RARE_RARITY
import com.google.gson.JsonElement
import net.minecraft.util.Rarity

class ConiumRareRarityTemplate : ConiumRarityTemplate(Rarity.RARE, RARE_RARITY) {
    companion object {
        fun create(element: JsonElement): ConiumRareRarityTemplate = element.createIfJsonObject(::ConiumRareRarityTemplate, notSupported())!!
    }
}