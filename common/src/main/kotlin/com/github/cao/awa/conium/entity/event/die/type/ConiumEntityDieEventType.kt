package com.github.cao.awa.conium.entity.event.die.type
...
class ConiumEntityDieEventType: ConiumCancelableEventType<EntityType<*>, ConiumEntityDieEventMetadata, EntityType<*>, ConiumEntityDeadEventMetadata>(
    "entity_die",
    "EntityType",
    ConiumEvent.Companion::entityDie
)