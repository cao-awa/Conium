package com.github.cao.awa.conium.item.event.use.entity.on.use.metadata
...
class ConiumItemUseOnEntityEventMetadata(val context: ConiumEventContext<Item>) : ConiumEventMetadata<Item, ConiumItemUseOnEntityEventMetadata>() {
