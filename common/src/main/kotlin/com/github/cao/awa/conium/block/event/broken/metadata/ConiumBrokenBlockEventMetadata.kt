package com.github.cao.awa.conium.block.event.broken.metadata
...
class ConiumBrokenBlockEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumBrokenBlockEventMetadata>() {
