package com.github.cao.awa.conium.blockentity.event.chest.open
 ...
 * @since 1.0.0
 */
class ConiumChestOpenedEvent : ConiumEvent<Block, ConiumChestOpenedEventMetadata, ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>>(
