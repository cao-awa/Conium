package com.github.cao.awa.conium.blockentity.event.shulker.closing.metadata
...
class ConiumShulkerBoxClosingEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumShulkerBoxClosingEventMetadata>() {
