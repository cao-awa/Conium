...
class ConiumFluidScheduleTickedEvent : ConiumEvent<Fluid, ConiumFluidScheduleTickedEventMetadata, ParameterSelective5<Boolean, ServerWorld, BlockPos, AbstractBlockState, FluidState, ScheduledTickView>>(
    ...
    override fun requirement(): ConiumArisingEventContext<Fluid, out ParameterSelective> {
        ...
        ) { identity: Any, world: ServerWorld, pos: BlockPos, blockState: AbstractBlockState, fluidState: FluidState, scheduler: ScheduledTickView ->
