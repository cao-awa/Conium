 ...
 * @since 1.0.0
 */
class ConiumChestOpeningEvent : ConiumEvent<Block, ConiumChestOpeningEventMetadata, ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>, ConiumChestOpenedEventType>(
