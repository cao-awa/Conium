    ...
    companion object {
        ...
        private val SOLE_INGREDIENT_GETTERS: Map<RegistryKey<RecipePropertySet>, SoleIngredientGetter> = mutableMapOf(
            ...
            Pair(
                ...
                SoleIngredientGetter { recipe: Recipe<*> -> if (recipe is SmithingRecipe) Optional.of(recipe.base()) else Optional.empty() }
            ),
            Pair(
            ...
            try {
                ...
                try {
                    ...
                    Recipe.CODEC.parse(ops, element).ifSuccess {
                        ...
                        try {
                            // Find the bedrock recipe and create it.
                            ConiumBedrockRecipeBuilder.findBedrock(json).let { recipes: List<Recipe<*>> ->
