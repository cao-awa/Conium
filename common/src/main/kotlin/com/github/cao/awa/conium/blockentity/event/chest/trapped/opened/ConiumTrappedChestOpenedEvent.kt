 ...
 * @since 1.0.0
 */
class ConiumTrappedChestOpenedEvent : ConiumEvent<Block, ConiumTrappedChestOpenedEventMetadata, ParameterSelective6<Boolean, World, PlayerEntity, TrappedChestBlockEntity, AbstractBlock.AbstractBlockState, BlockPos, ViewerCountManager>, ConiumInactiveEventType>(
