package com.github.cao.awa.conium.molang.translator.program.constant.number
...
import com.github.cao.awa.conium.molang.translator.element.program.constant.number.MolangNumberElementTranslator
...
class MolangKotlinScriptNumberTranslator: MolangKotlinScriptTranslator<MolangNumber>(), MolangNumberElementTranslator {
    override fun translate(builder: StringBuilder, ast: MolangNumber) {
