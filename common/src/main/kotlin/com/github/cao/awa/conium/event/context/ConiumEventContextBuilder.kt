...
object ConiumEventContextBuilder {
    ...
    private fun <P : ParameterSelective, I : Any, M: ConiumEventMetadata> forever(eventType: ConiumEventType<I, M>, dynamicArgs: DynamicArgs<P, Boolean>): ConiumArisingEventContext<P> {
