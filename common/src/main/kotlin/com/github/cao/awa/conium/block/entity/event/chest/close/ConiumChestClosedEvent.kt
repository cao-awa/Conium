 ...
 * @since 1.0.0
 */
class ConiumChestClosedEvent : ConiumEvent<ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>, ConiumChestClosedEventMetadata>(
    ...
    override fun metadata(context: ConiumEventContext): ConiumChestClosedEventMetadata {
