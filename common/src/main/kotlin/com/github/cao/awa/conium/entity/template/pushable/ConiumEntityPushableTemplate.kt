...
class ConiumEntityPushableTemplate(
    ...
    companion object {
        @JvmStatic
        fun create(element: JsonElement, name: String): ConiumEntityPushableTemplate = element.objectOrBoolean(
            {
        ...
        @JvmStatic
        fun create(element: JsonElement): ConiumEntityPushableTemplate = create(element, PUSHABLE)
    }
