package com.github.cao.awa.conium.block.event.breaks.type
...
class ConiumBreakBlockEventType: ConiumCancelableEventType<Block, ConiumBreakBlockEventMetadata, Block, ConiumBrokenBlockEventMetadata>(
    "break_block",
    "Block",
    ConiumEvent.Companion::breakBlock
)