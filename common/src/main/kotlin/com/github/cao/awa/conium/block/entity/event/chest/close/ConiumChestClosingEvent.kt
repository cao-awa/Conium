 ...
 * @since 1.0.0
 */
class ConiumChestClosingEvent : ConiumEvent<ParameterSelective6<Boolean, World, PlayerEntity, ChestBlockEntity, AbstractBlockState, BlockPos, ViewerCountManager>, ConiumChestClosingEventMetadata>(
    ...
    override fun metadata(context: ConiumEventContext): ConiumChestClosingEventMetadata {
