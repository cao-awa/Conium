package com.github.cao.awa.conium.blockentity.event.shulker.closed.metadata
...
class ConiumShulkerBoxClosedEventMetadata(val context: ConiumEventContext<Block>) : ConiumEventMetadata<Block, ConiumShulkerBoxClosedEventMetadata>() {
