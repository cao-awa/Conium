...
class ConiumFluidScheduleTickEvent : ConiumEvent<ParameterSelective5<Boolean, ServerWorld, BlockPos, AbstractBlockState, FluidState, ScheduledTickView>, ConiumFluidScheduleTickEventMetadata>(
    ...
    override fun metadata(context: ConiumEventContext): ConiumFluidScheduleTickEventMetadata {
