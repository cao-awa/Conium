...
class ConiumUseBlockEvent : ConiumEvent<ParameterSelective5<Boolean, World, PlayerEntity, BlockPos, AbstractBlockState, BlockHitResult>>(ConiumEventType.USE_BLOCK) {
