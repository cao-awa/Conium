...
class ConiumCommonRarityTemplate : ConiumRarityTemplate(Rarity.COMMON, COMMON_RARITY) {
    companion object {
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumCommonRarityTemplate = element.createIfJsonObject(::ConiumCommonRarityTemplate, notSupported())!!
    }
}