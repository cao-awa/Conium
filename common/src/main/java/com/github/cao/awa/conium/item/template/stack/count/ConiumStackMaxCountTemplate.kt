...
class ConiumStackMaxCountTemplate(private val stackMaxCount: Int) : ConiumItemTemplate(name = STACK_MAX_COUNT) {
    companion object {
        @JvmStatic
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumStackMaxCountTemplate = ConiumStackMaxCountTemplate(validateStackSize(element.asInt))
    }
