...
class ConiumEpicRarityTemplate : ConiumRarityTemplate(Rarity.EPIC, EPIC_RARITY) {
    companion object {
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumEpicRarityTemplate = element.createIfJsonObject(::ConiumEpicRarityTemplate, notSupported())!!
    }
}