...
class ConiumItemNetheritePickaxeTemplate : ConiumItemPickaxeTemplate(
    ...
    companion object {
        @JvmStatic
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumItemNetheritePickaxeTemplate = element.createIfJsonObject(::ConiumItemNetheritePickaxeTemplate, notSupported())!!
    }
}
