...
open class ConiumExplosionResistanceTemplate(private val explosionResistance: Float, name: String = EXPLOSION_RESISTANCE) : ConiumBlockTemplate(name = name) {
    companion object {
        @JvmStatic
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumExplosionResistanceTemplate = ConiumExplosionResistanceTemplate(element.asFloat)
    }
