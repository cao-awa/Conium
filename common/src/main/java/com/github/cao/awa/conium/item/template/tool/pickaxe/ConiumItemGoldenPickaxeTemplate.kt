...
class ConiumItemGoldenPickaxeTemplate : ConiumItemPickaxeTemplate(
    ...
    companion object {
        @JvmStatic
        fun create(element: JsonElement, registryLookup: RegistryWrapper.WrapperLookup): ConiumItemGoldenPickaxeTemplate = element.createIfJsonObject(::ConiumItemGoldenPickaxeTemplate, notSupported())!!
    }
}
